...
//				panic("mock out the QueryName method")
//			},
//		}
//
...
type QueryMock struct {
	// QueryNameFunc mocks the QueryName method.
	QueryNameFunc func() string

	// calls tracks calls to the methods.
	calls struct {
		// QueryName holds details about calls to the QueryName method.
		QueryName []struct {
		}
	}
	lockQueryName sync.RWMutex
}

// QueryName calls QueryNameFunc.
func (mock *QueryMock) QueryName() string {
	if mock.QueryNameFunc == nil {
		panic("QueryMock.QueryNameFunc: method is nil but Query.QueryName was just called")
	}
	callInfo := struct {
	}{}
	mock.lockQueryName.Lock()
	mock.calls.QueryName = append(mock.calls.QueryName, callInfo)
	mock.lockQueryName.Unlock()
	return mock.QueryNameFunc()
}

// QueryNameCalls gets all the calls that were made to QueryName.
// Check the length with:
//
//	len(mockedQuery.QueryNameCalls())
func (mock *QueryMock) QueryNameCalls() []struct {
} {
	var calls []struct {
	}
	mock.lockQueryName.RLock()
	calls = mock.calls.QueryName
	mock.lockQueryName.RUnlock()
	return calls
}
